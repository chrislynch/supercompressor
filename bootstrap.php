...
array_drill_set('_configuration.categories.products.heading','Browse by Product',$data);
array_drill_set('_configuration.categories.products.menu','Products',$data);
array_drill_set('_configuration.categories.brand.heading','Browse by Brand',$data);
